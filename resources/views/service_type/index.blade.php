...
<div class="mx-5 px-5">
    <table class="table table-hover">
        ...
        <a href="service_type/create" class="btn btn-success  mb-5">Crear Tipo de servicio</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="row">
                        <a class="btn" href="{{ route('service_type.edit', $service_type->id) }}"><i class="bi bi-pencil-square" style="color:green; font-size:150%"></i></a>
                    </div>
                </td>
                <td class="text-center">

                    <form action="{{ route('service_type.destroy', $service_type->id) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
